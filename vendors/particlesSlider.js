...
psParticle.prototype.move = function() {
    ...
    $(document).on("click", ".section-ready-to-contact a", function() {
        ...
        ga.apply(this, e.concat(["engagement", "opened related article", "opened related article on page " + window.location.pathname + " direction - " + t($(this).attr("href")).pathname]))
    }), $(document).on("click", ".article-related a", function() {
        ga.apply(this, e.concat(["engagement", "opened related article on blog", "opened related article on page " + window.location.pathname + " direction - " + t($(this).attr("href")).pathname]))
    }), $(document).on("click", ".article-w a", function() {
        this.href.includes("yalantis.com/blog") && ga.apply(this, e.concat(["engagement", "opened relevant article", "opened relevant article on page " + window.location.pathname + " direction - " + t($(this).attr("href")).pathname]))
